...
@section('content')
    ...
    <div class="body-content outer-top-xs">
        <div class='container'>
                                ...
                                <div class="product-item-holder size-big single-product-gallery small-gallery">
                                    ...
                                    <div id="owl-single-product">
                                        <div class="single-product-gallery-item" id="slide1">
                                            <a data-lightbox="image-1" data-title="Gallery" href="{{asset('upload/products/'.$product->image)}}">
                                                <img class="img-responsive" alt="" src="{{asset('upload/products/'.$product->image)}}" data-echo="{{asset('upload/products/'.$product->image)}}" />
                                            </a>
                                           ...
                                           @foreach($product as $row)
                                            <div class="item">
                                                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                                                    <img class="img-responsive" width="85" alt="" src="{{asset('upload/products/'.$row)}}" data-echo="{{asset('upload/products/'.$row)}}" />
                                                </a>
                                            </div>
                                               @endforeach
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    ...
                                                    <span class="price" style="color: red">৳{{$price ?
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                fa-shopping-cart
                                                inner-right-vs"></i>ADD TO CART</button>
            ...
            <!-- ============================================== RELETED PRODUCTS ============================================== -->
            <div class="row">
                <div class="head"><h2>Related Product</h2></div>
                <hr>
                <hr>
